      ...
      <header className="border-b bg-background/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-2xl font-bold text-foreground">TeleDrive</h1>
          </div>
          <Button 
      ...
      <section className="py-12 md:py-20 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            <Card className="bg-card/60 backdrop-blur-sm border shadow-lg hover:shadow-xl transition-all duration-300">
              <CardHeader>
          ...
          {/* File Types */}
          <div className="bg-card/60 backdrop-blur-sm rounded-xl p-6 md:p-8 shadow-lg">
            <h3 className="text-xl md:text-2xl font-bold text-foreground mb-6">Support for All File Types</h3>
            <div className="flex flex-wrap justify-center gap-4">
              {[
                ...
                <div key={index} className="flex items-center space-x-2 bg-background rounded-lg px-4 py-2 shadow-sm">
